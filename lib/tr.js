...
function TranslationRequest(gp, props) {
  ...
  if(this.cancelledAt) {
    this.cancelledAt = utils.datify(this.cancelledAt);
  }
...
TranslationRequest.prototype.getInfo = function getTranslationRequest(opts, cb) {
  ...
  return this.gp.restCall("translation_request.getTranslationRequest", {
