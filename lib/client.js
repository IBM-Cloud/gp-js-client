...
function Client(options) {
  ...
  var needAll = ' - need { url: ...,  api: ... }';
  if ( !this._options.url ) {
    throw new Error("gaas: missing 'url' in options " + needAll);
  }
  if ( !this._options.api ) {
    throw new Error("gaas: missing 'api' in options " + needAll);
  }
...
module.exports = {
   ...
   * @param {string} params.url - service URL. (should end in '/translate')
   * @param {string} params.api - service API key.
   * @returns {Client}
   */
