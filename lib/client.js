 ...
 * @param {basicCallback} cb
 */
Project.prototype.addTargetLanguages = function addTargetLanguages(args, cb) {
 ...
 * @param {object} args
 * @param {boolean} args.replace - if true, replace ALL resource keys instead of just appending
 * @param {boolean} args.retry - if true, retry translation
 ...
 * @param {object} args
 * @param {string} args.langaugeID - langauge to update (source or target)
 * @param {boo
 * @param {basicCallback} cb
 */
